...
def add_features(train_data="./datasets/green_tripdata_2021-03.parquet", additional_training_data=None):
...
if __name__ == "__main__":
    ...
    X_train, y_train, dv = add_features(
        additional_training_data="./datasets/green_tripdata_2021-04.parquet"
    )
